...
export default function ClientesPage() {
  ...
  function exportarExcel() {
    ...
    ws['!cols'] = [{ wch: 30 }, { wch: 15 }, { wch: 20 }, { wch: 15 }, { wch: 25 }, { wch: 30 }, { wch: 10 }];
    ...
    <div className="materiales-page">
      ...
      <div className="page-header bg-white border-bottom px-3 px-lg-4 py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div className="d-flex gap-2 flex-wrap">
          <button className="btn btn-outline-success d-flex align-items-center gap-1" onClick={exportarExcel} disabled={clientes.length === 0} title="Exportar a Excel">
